    ...
    <div className="py-16 space-y-8 px-4">
      {[1, 2, 3, 4, 5, 6].map((_, i) => (
        <div key={i} className="flex flex-col items-start">
          ...
          <div className="flex space-x-5 mt-4 text-gray-700 py-2.5 border-t border-b-[1px] w-full">
      ...
      <button className="fixed bottom-24 right-5 bg-orange-400 rounded-full p-4 text-white shadow-xl cursor-pointer hover:bg-orange-600 transition-colors">
        <svg
          className="w-6 h-6"
          fill="none"
          stroke="currentColor"
